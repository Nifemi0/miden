...
export function UserManagement() {
  ...
  const handleAddUser = async () => {
    ...
    try {
      // Mock API call to register new user
      const addedUser = await registerNewUser(newUser)
...
async function fetchMockUsers(): Promise<User[]> {
  ...
  return [
    ...
    },
    {
      ...
      last_active: '2024-01-18T09:20:00Z'
    },
    {
      id: '4',
    ...
    },
    {
      ...
      last_active: '2024-01-20T11:10:00Z'
    }
  ]
}
...
async function registerNewUser(userData: NewUser): Promise<User> {
