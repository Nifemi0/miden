...
export function ProposalManagement() {
  ...
  const loadProposals = async () => {
    setIsLoading(true)
    try {
      // Mock API call to fetch proposals
      const mockProposals = await fetchMockProposals()
  ...
  const handleRevokeProposal = async (proposalId: string) => {
    try {
      // Mock API call to revoke proposal
  ...
  const handleFinalizeTally = async (proposalId: string) => {
    try {
      // Mock API call to finalize tally
...
// Mock API functions
async function fetchMockProposals(): Promise<Proposal[]> {
  ...
  return [
    {
      ...
      description: 'Proposal to increase the protocol fee from 0.3% to 0.5% to fund development and security audits.',
      status: 'active',
    ...
    },
    {
      id: 'prop_2',
      project_id: 'proj_1',
      title: 'Add New Trading Pair: ETH/USDT',
      description: 'Proposal to add ETH/USDT trading pair to the protocol with initial liquidity rewards.',
      status: 'passed',
    ...
    },
    {
      id: 'prop_3',
      project_id: 'proj_2',
      title: 'Implement Royalty Cap at 10%',
      description: 'Proposal to implement a maximum royalty cap of 10% for all NFT collections on the marketplace.',
      status: 'active',
      voting_model: 'one-person-one-vote',
    ...
    },
    {
      id: 'prop_4',
      project_id: 'proj_3',
      title: 'Season 2 Token Distribution',
      description: 'Proposal for token distribution mechanism for Season 2 of the gaming platform.',
      status: 'failed',
      voting_model: 'token-weighted',
    ...
    },
    {
      ...
      description: 'Proposal to modify the staking rewards structure to incentivize long-term holding.',
      status: 'pending',
      voting_model: 'quadratic',
...
async function revokeProposal(proposalId: string): Promise<void> {
  await new Promise(resolve => setTimeout(resolve, 500))
  // Mock API call successful
}

async function finalizeTally(proposalId: string): Promise<void> {
